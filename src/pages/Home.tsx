...
export function Home() {
  return (
    <>
      <Header />
      <main className="w-full max-w-[1200px] my-0 mx-auto md:py-8 md:mt-[1rem] gap-12 text-white">
        ...
        <section className="mx-6 mb-16 flex-col flex gap-4 items-center md:flex-row">
        ...
        <section className="m-6 mb-8 flex items-center flex-col md:mt-[8rem]">
      ...
      <footer className="w-full text-white h-60 md:h-48 bg-[#242424]">
        <div className="max-w-[1200px] flex-col p-6 my-0 mx-auto flex justify-between items-center md:flex-row">
          {/* <h1 className="text-6xl">ESC</h1> */}
          <img className="w-72 mb-6 m-2" src={logoImg} alt="" />
          <div>
            <div className="flex w-[22rem] py-2 flex-col items-center md:items-start">
